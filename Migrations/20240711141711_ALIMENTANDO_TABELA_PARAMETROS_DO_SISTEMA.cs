    ...
    public partial class ALIMENTANDO_TABELA_PARAMETROS_DO_SISTEMA : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("INSERT INTO parametrosdosistema" +
               ...
               "('SysLogica - Testes','Rua Miguel Petroni 2338 - Sala 3',true,true," +
               "'Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\SAAB\\BASE\\CONTAS.mdb',true,'Sem Impressora'," +
               ...
               "120,30,false,'nenhum','nenhum','nenhuma','São Carlos',true,true);");
